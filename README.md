...
```bash
STACK_NAME=stag-foodoo-dev sh ./scripts/deploy.sh
```
...
services:
  db:
    ...
    deploy:
      placement:
        constraints:
          - node.labels.foodoo-dev.app-db-data == true
```
...
```bash
docker node update --label-add foodoo-dev.app-db-data=true dog.example.com
```

* Then you need to do the same for each stack version you have. For example, for staging you could do:

```bash
docker node update --label-add stag-foodoo-dev.app-db-data=true cat.example.com
```
...
* Set these environment variables:
  * `DOMAIN=foodoo.dev`
  * `TRAEFIK_TAG=foodoo.dev`
  * `STACK_NAME=foodoo-dev`
  * `TAG=prod`
...
Frontend: https://foodoo.dev

Backend: https://foodoo.dev/api/

Automatic Interactive Docs (Swagger UI): https://foodoo.dev/docs

Automatic Alternative Docs (ReDoc): https://foodoo.dev/redoc

PGAdmin: https://pgadmin.foodoo.dev

Flower: https://flower.foodoo.dev

### Staging URLs

Staging URLs, from the branch `master`.

Frontend: https://stag.foodoo.dev

Backend: https://stag.foodoo.dev/api/

Automatic Interactive Docs (Swagger UI): https://stag.foodoo.dev/docs

Automatic Alternative Docs (ReDoc): https://stag.foodoo.dev/redoc

PGAdmin: https://pgadmin.stag.foodoo.dev

Flower: https://flower.stag.foodoo.dev
...
Frontend: http://dev.foodoo.dev

Backend: http://dev.foodoo.dev/api/

Automatic Interactive Docs (Swagger UI): https://dev.foodoo.dev/docs

Automatic Alternative Docs (ReDoc): https://dev.foodoo.dev/redoc

PGAdmin: http://dev.foodoo.dev:5050

Flower: http://dev.foodoo.dev:5555

Traefik UI: http://dev.foodoo.dev:8090
