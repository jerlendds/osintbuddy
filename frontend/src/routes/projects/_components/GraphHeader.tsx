...
export default function GraphHeader({ graph, stats }: JSONObject) {
        ...
        <div className="py-1 w-full mx-auto">
          <section className="flex flex-col items-start justify-between px-4 lg:items-center lg:px-6 md:px-4 lg:flex-row md:flex-row md:items-center  relative">
            ...
            <div className="flex w-full gap-x-4 mt-auto">
              <button className="mb-3.5 ring-1 ring-danger-600 ml-auto pr-3 text-left text-sm font-semibold text-danger-600 hover:text-danger-700 flex items-center border border-danger-600 hover:border-danger-700 py-2 px-3 rounded-md mr-1 ">
                Delete graph
