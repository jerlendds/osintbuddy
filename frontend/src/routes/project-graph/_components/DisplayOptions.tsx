...
import { setNodeType } from '@/features/graph/graphSlice';
        ...
        <div className='h-12 flex items-center flex-col bg-dark-700 mr-2'>
          <fieldset className='isolate inline-flex shadow-sm'>
            ...
            >
              ...
              <Square2StackIcon
                className={classNames('h-6 w-6', viewMode === 'base' && 'text-info-100')}
                aria-hidden='true'
              />
            </button>
            <button
            ...
            >
              <span className='sr-only'>List view</span>
              <Squares2X2Icon
                className={classNames('h-6 w-6', viewMode === 'mini' && 'text-info-100')}
                aria-hidden='true'
              />
            </button>
          </fieldset>
