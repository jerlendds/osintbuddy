...
const links = [
  { title: 'Documentation', description: 'Learn about OSINTBuddy', icon: BookOpenIcon },
  { title: 'Architecture guide', description: 'Overview of the OSINTBuddy architecture', icon: BookmarkSquareIcon },
];
const social = [
  {
    name: 'Twitter',
